        ...
        if answer == "Bow":
            ...
            if rain == 1:
                ...
                if r1 == 0 or r1 == 1:
                    ...
                    print()
                    sleep(0.5)
                    print("But 1P have (DEF IV) so , 1P damage only is 1.2537363362 .")
                    print()
                    sleep(0.5)
                    print("But 2P have (ATK II) so , 1P damage finally is 1.7836363535 .")
                    hp1 = hp1 - 1
                    hp2 = hp2 - 15
                    ...
                    print()
                    sleep(0.5)
                    print("But 1P have (DEF IV) so , 1P damage only is 5.67 .")
                    print()
                    sleep(0.5)
                    print("But 2P have (ATK II) so , 1P damage finally is 6 .")
                    hp1 = hp1 - 6
                    hp2 = hp2 - 2
